package net.ctrdn.stuba.pks.netanalyser.am.ftp;
...
@Analyser(
        name = "FTP Packet Analyser",
        version = "1.0.0"
)
public class FtpAnalyserModule implements AnalyserModule<IPv4Frame> {

    public DefaultIPv4ConnectionAnalysisPanel panel = new DefaultIPv4ConnectionAnalysisPanel("FTP");
    ...
    public void parse(List<IPv4Frame> frameList, int filteredFrameCount, int totalFrameCount) throws AnalyserModuleException {
        ...
        analysis.addFilter(FilterFactory.tcpPortFilter(FilterPortDirection.SRC_OR_DST_PORT, 21));
        analysis.addFilter(FilterFactory.tcpPortFilter(FilterPortDirection.SRC_OR_DST_PORT, 20));
        analysis.addFilter(FilterFactory.udpPortFilter(FilterPortDirection.SRC_OR_DST_PORT, 20));
        analysis.analyze();
